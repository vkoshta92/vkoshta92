...
🎮 Additionally experienced in **interactive game development (PixiJS)**  
...
- ⚡ Optimize **performance (lazy loading, caching, bundle optimization)**  
...
### 🎮 Game Development (Additional Strength)  

- 🎰 Built **high-performance slot games using PixiJS (Canvas/WebGL)**  
- 🎲 Implemented **complex game logic (reels, randomness, state handling)**  
- ⚡ Worked on **smooth animations & rendering optimization**  

> This strengthens my understanding of **performance, rendering & real-time systems**
